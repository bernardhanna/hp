...
if ($link_source === 'auto_terms') {
    ...
    if ($only_current) {
        ...
        // Apply client-side sorting to match orderby/order for current-post terms
        if (!empty($terms)) {
        ...
        <div class="flex flex-wrap gap-4">
          ...
          ?>
            <a
              ...
              class="w-fit whitespace-nowrap px-6 py-2 text-base leading-6 bg-gray-200 rounded-[100px] text-slate-700 hover:bg-hover hover:text-hover max-md:text-base max-sm:text-sm"
            >
