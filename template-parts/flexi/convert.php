...
<section class="relative flex pb-40 overflow-hidden pt-36 bg-teal-50 max-md:pt-24 max-md:pb-28">
  <div class="flex flex-col items-center w-full pt-5 pb-5 mx-auto max-w-full max-lg:px-5">
...
<section class="relative flex pb-40 overflow-hidden bg-white pt-36 max-md:pt-24 max-md:pb-28">
  <div class="flex flex-col items-center w-full pt-5 pb-5 mx-auto max-w-full max-lg:px-5">
    <div class="w-full px-4 mx-auto max-w-full">
      <div class="mb-10 text-center max-sm:mb-5">
...
<section class="relative w-full overflow-hidden">
  <div class="flex flex-row items-center w-full pt-5 pb-5 mx-auto lg:gap-20 max-md:flex-col max-w-full max-xxl:px-5">
